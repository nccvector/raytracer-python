...
if __name__ == "__main__":
    ...
    objects = [
        Sphere(Vector3(-300.0,0.0,300.0), 100.0, Color(0.5,0.5,0.5), material_type='Standard'), 
        Sphere(Vector3(-150.0,0.0,150.0), 100.0, Color(0.9,0.9,0.9), material_type='Standard'), 
        Sphere(Vector3(0.0,0.0,0.0), 100.0, Color(1.0,0.1,0.1), material_type='Standard'), 
        Sphere(Vector3(150.0,0.0,150.0), 100.0, Color(0.1,0.1,1.0), material_type='Standard'), 
        Sphere(Vector3(300.0,0.0,300.0), 100.0, Color(0.1,1.0,0.1), material_type='Standard'), 
        Plane(Vector3(0.0,-100.0, 0.0), Vector3(0.0,1.0,0.0), Color(1.0,1.0,1.0), material_type='Standard'),
    ]
    ...
    for x in range(cam.canvas_size[0]):
        for y in range(cam.canvas_size[1]):
            ...
            col = Trace(r, objects, lights) # Non reflective trace
