...
class color():
    ...
    def __add__(self, other):  # Operator +
        ...
        Description:
            ...
            adds with all components of color
...
def trace(r, bounces):
    ...
    if closest_object:
        ...
        return color_to_return * intensity, None

    return color(0,0,0), None
...
if __name__ == "__main__":
    ...
    frame_origin = vector3(0.0,0.0,0.0 + ray_origin.z * -samples)
    ...
    for x in range(0, image_shape[1]):
        ...
        if (x+1)%int(image_shape[1]/50) == 0 or x+1 == image_shape[1]:
