...
if __name__ == "__main__":
    ...
    reflectness = 1 # Amount of contribution of reflection bounce
    roughness = 0.5 # Amount of bluriness of reflection bounce
    objects = [
        Sphere(Vector3(-300.0,0.0,300.0), 100.0, Color(0.5,0.5,0.5), material_type='Reflective', reflectness=reflectness, roughness=roughness), 
        Sphere(Vector3(-150.0,0.0,150.0), 100.0, Color(0.9,0.9,0.9), material_type='Reflective', reflectness=reflectness, roughness=roughness), 
        Sphere(Vector3(0.0,0.0,0.0), 100.0, Color(1.0,0.1,0.1), material_type='Reflective', reflectness=reflectness, roughness=roughness), 
        Sphere(Vector3(150.0,0.0,150.0), 100.0, Color(0.1,0.1,1.0), material_type='Reflective', reflectness=reflectness, roughness=roughness), 
        Sphere(Vector3(300.0,0.0,300.0), 100.0, Color(0.1,1.0,0.1), material_type='Reflective', reflectness=reflectness, roughness=roughness), 
        Plane(Vector3(0.0,-100.0, 0.0), Vector3(0.0,1.0,0.0), Color(1.0,1.0,1.0), material_type='Reflective', reflectness=reflectness, roughness=roughness),
    ]
