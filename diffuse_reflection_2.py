...
# objects
objects = [
    sphere(vector3(-100.0,0.0,0.0), 100.0, color(1.0,0.1,0.1), material_type='Reflective'), 
    sphere(vector3(50.0,0.0,150.0), 100.0, color(0.1,0.1,1.0), material_type='Reflective'), 
    sphere(vector3(200.0,0.0,300.0), 100.0, color(0.1,1.0,0.1), material_type='Reflective'), 
...
if __name__ == "__main__":
    ...
    theta = 32.5
    perpendicular = image_shape[1]/2 # width
    frame_distance = perpendicular/(math.tan(math.radians(theta)))
    # ray and canvas coordinates
    ray_origin = vector3(200.0,0.0, -1500)
    frame_origin = vector3(200.0,0.0, ray_origin.z + frame_distance)
    ...
    cv2.imwrite('./output.png',image_area)
    cv2.waitKey(0)